...
router.post("/",async(req,res)=>{
    ...
    try {
        ...
        //determine if user is loggedin or guest
        ...
        if(cart){
            ...
            if(productIndex > -1){
                //if the product alreay exists, update the quantity
...
//@route PUT /api/cart
//@desc update  product to the cart for a guest or logged in user
//@access public
...
//@desc merge guest cart into users cart on login
//@access private
