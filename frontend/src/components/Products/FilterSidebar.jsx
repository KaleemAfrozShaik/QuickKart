    ...
    return (
        <div className="p-4">
            ...
            <div className="mb-6">
                ...
                {categories.map((category)=>(
                    <div className="flex items-center mb-1" key={category}>
                        ...
                        className="mr-2 h-4 w-4 accent-black text-blue-500 focus:ring-blue-400 border-gray-300"/>
            ...
            <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                    {colors.map((color)=>(
                        ...
                        cursor-pointer transition hover:scale-105 ${filters.color===color?"ring-blue-500":""}`}
            ...
            <div className="mb-8">
                ...
                className="w-full h-2 accent-black bg-gray-300 rounded-lg appearance-none cursor-pointer"/>
