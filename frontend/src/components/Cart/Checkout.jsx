...
const Checkout = () => {
    ...
    //ensure cart is not loaded beforw proceeding
    useEffect(()=>{
    ...
    const handlePaymentSucsess= async (details)=>{
        try {
            ...
            <div className="bg-white rounded-lg p-6">
                ...
                <form onSubmit={handleCreateCheckout}>
                    ...
                    <div className="mb-4">
                        ...
                        className="w-full p-2 border-[0.1px] rounded" 
                        disabled/>
                    </div>
                    ...
                    <div className="mt-6">
                        {!checkoutId ? (
                            ...
                            <div>
                                ...
                                onSuccess={handlePaymentSucsess} 
                                onError={(err) => {
