        ...
        <div className="flex">
            <div className="w-full flex md:w-1/2 flex-col justify-center items-center p-8 md:p-12">
                ...
                action="" className="w-full max-w-md bg-white p-8 rounded-lg border shadow-sm">
                    <div className="flex justify-ceneter mb-6">
                        <h2 className="text-xl font-medium">QuickKart</h2>
                    </div>
            ...
            <div className="hidden md:block w-1/2 bg-gray-800">
                <div className="h-full flex flex-col justify-center items-center">
                    <img src={register} alt="loginImage" className="h-[650px] w-full object-cover"/>
                </div>
            </div>
        </div>
    );
